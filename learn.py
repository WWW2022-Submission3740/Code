...
def main():
    ...
    try:
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if val_loss < best_val:
                ...
                best_val = val_loss
                valid_hidden = get_train_hidden(Data, Data.valid[0], Data.valid[1], model, args.hidden_batch_size)
                train_hidden = torch.cat([train_hidden, valid_hidden])
    ...
    train_hidden = get_train_hidden(Data, Data.train[0], Data.train[1], model, args.hidden_batch_size)
    vtest_acc, vtest_rae, vtest_corr, _, _ = evaluate(Data, Data.valid[0], Data.valid[1], model, evaluateL2, evaluateL1, args.batch_size, train_hidden)
    valid_hidden = get_train_hidden(Data, Data.valid[0], Data.valid[1], model, args.hidden_batch_size)
    train_hidden = torch.cat([train_hidden, valid_hidden])
    test_acc, test_rae, test_corr, test_predict, test_test = evaluate(Data, Data.test[0], Data.test[1], model, evaluateL2, evaluateL1, args.batch_size, train_hidden)
